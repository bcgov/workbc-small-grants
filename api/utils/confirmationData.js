...
module.exports = {
    getOrgSubmitted(values){
        var data = [
            ...
            `Partnering business contact address 1: ${strings.orEmpty(partneringBusinessActivities)}`,
            `Partnering business contact address 2: ${strings.orEmpty(partneringBusinessActivities)}`,
            `Partnering business contact city: ${strings.orEmpty(partneringBusinessActivities)}`,
            `Partnering business contact postal: ${strings.orEmpty(partneringBusinessContactPostal)} `,
