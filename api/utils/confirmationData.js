...
module.exports = {
    getOrgSubmitted(values){
        var data = [
            ...
            `Non Profit Classification (if non-profit or charity):  ${strings.orEmpty(values.nonProfitClassification)}`,
            `Non Profit SubClassification (if non-profit or charity):  ${strings.orEmpty(values.nonProfitSubClassification)}`,
            `Non Profit Other SubClassification (if non-profit or charity):  ${strings.orEmpty(values.nonProfitSubClassificationOther)}`,
