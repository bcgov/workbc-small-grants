      ...
      <tbody>
        <tr>
          <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 15px; width: 100%; margin: 0;" align="left">
            <div>
        <img class="img-fluid" width="800" height="160" border="0" id="BC_WorkBC_Banner_Top" src="${clientURL}/images/emailBannerTop_BCOnly.png" alt="BC Logo" style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 100%; border: 0 none;">
