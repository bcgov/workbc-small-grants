...
const SurveyOrgValidationSchema = require("../schemas/SurveyOrgValidationSchema")
...
const surveyOrgListEmail = process.env.SURVEYORG_LISTEMAIL || process.env.OPENSHIFT_NODEJS_SURVEYORG_LISTEMAIL || ""
