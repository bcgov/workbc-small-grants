        ...
        return (
            <div>
                ...
                <div className="form-group">
                    <div className="row">
                        <div className="col-md-6 col-sm-12 col-xs-12">
                            <label className="col-form-label control-label" htmlFor="speedApplicationProcessed">My organization was satisfied with the speed of how quickly the application was processed.<span style={{ color: "red" }}>*</span></label>
                        </div>
                        <div className="form-check form-check-inline col">
                            <Field
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="experienceOnlineApplicationComments">Please provide any additional details or comments about your organization’s experience with the online application process.
                </label>
                    <small className="text-muted" id="experienceOnlineApplicationComments"> (1000 characters max.)</small>
                    <Field
                        as="textarea"
