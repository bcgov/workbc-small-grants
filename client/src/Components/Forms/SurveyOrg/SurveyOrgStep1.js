    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="statisfactionSpeedOfService">1c. Satisfaction about the speed of service.<span style={{ color: "red" }}>*</span></label>
                    <div className="form-check">
                        <Field
                            className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "statisfactionSpeedOfService")}`}
                            type="radio"
                            name="statisfactionSpeedOfService"
                            value="1poor"
                        />
                        <label className="form-check-label">1 (poor)</label>
                    </div>
                    <div className="form-check">
                        ...
                        />
                        <label className="form-check-label">2 (fair)</label>
                        {feedBackInvalid(this.props.errors, this.props.touched, "statisfactionSpeedOfService")}
                    </div>
                    <div className="form-check">
                        <Field
                            className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "statisfactionSpeedOfService")}`}
