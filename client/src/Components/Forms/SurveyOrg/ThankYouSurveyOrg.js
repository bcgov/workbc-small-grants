            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <p>The Wage Subsidy program covers a part of employee wages so employers can hire job seekers. Find out more by clicking <a href="https://www.workbc.ca/Employment-Services/Wage-Subsidy.aspx" target="_blank"> here.</a></p>
