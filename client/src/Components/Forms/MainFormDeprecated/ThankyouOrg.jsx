                ...
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <p>
                            ...
                            before work can commence so please submit your participant applications as soon as possible to get this process started.
                            September 15, 2021 is the deadline for submitting your participant application forms.
                        </p>
                        <p>
                        ...
                        <div className="card border-dark">
                            <div className="card-body">
                                ...
                                <p>
                                    <a
                                        href={`${window.location.origin}/participantForm/3/${applicationId}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >{`${window.location.origin}/participantForm/3/${applicationId}`}</a>
                                </p>
                                <p>
                        ...
                        <p>
                            ...
                            {this.props.location.state !== undefined && this.props.location.state.confirmOrganizationNonProfit}
                        </p>
                        <p>
                            Other Business/Organization Type Specify:{" "}
                            {this.props.location.state !== undefined && this.props.location.state.otherBusinessOrgSpecify}
                        </p>
                        ...
                        <p>
                            Non Profit Classification (if non-profit or charity):{" "}
                            {this.props.location.state !== undefined && this.props.location.state.nonProfitClassification}
                        </p>
                        <p>
                            Non Profit SubClassification (if non-profit or charity):{" "}
                            {this.props.location.state !== undefined && this.props.location.state.nonProfitSubClassification}
                        </p>
                        <p>
                            Non Profit Other SubClassification (if non-profit or charity):{" "}
                        ...
                        <p>
                            Placement length confirmation:{" "}
                            {this.props.location.state !== undefined && this.props.location.state.placementLength.toString()}
                        </p>
                        ...
                        <p>
                            Stipend confirmation: {this.props.location.state !== undefined && this.props.location.state.participantStipend.toString()}
                        </p>
                        <p>
