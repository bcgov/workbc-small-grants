                ...
                <div className="row">
                    ...
                    */}
                        ...
                        <div className="alert alert-primary alert-dismissible fade show" role="alert">
                            To navigate the form, use the Previous and Next buttons at the bottom. Using the Browser Back or Forward button will not
                            retain the form information.
                        ...
                        >
                            {(props) => (
                                <Form>
                                    <FormStep1 currentStep={this.state.currentStep} {...props} />
                                    <FormStep2 currentStep={this.state.currentStep} {...props} />
                                    <FormStep3 currentStep={this.state.currentStep} hasError={this.state.hasError} {...props} />
                                    {this.previousButton}
                                    {this.nextButton()}
                                </Form>
                            )}
