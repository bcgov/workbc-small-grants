    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="organizationOutcomesBenefitFromProgram">
                        How did your organization benefit from participation in the program?
                    </label>
                    <small className="text-muted" id="organizationOutcomesBenefitFromProgram">
                        {" "}
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="organizationOutcomesCommunityBenefit">
                        Please describe any community benefit resulting from your organization’s participation in the WEOG.
                    </label>
                    <small className="text-muted" id="organizationOutcomesCommunityBenefit">
                        {" "}
                        Please describe (500 characters max.){" "}
                    </small>
                    <Field
