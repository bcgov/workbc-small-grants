        ...
        if (this.props.values.recruitmentParticipantsSource.indexOf("other") > -1) {
            return (
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="recruitmentOtherSourceExplain">Other <span
                        style={{ color: "red" }}>*</span>
                    </label>
                    <small className="text-muted" id="recruitmentOtherSourceExplain"> Please describe (500 characters max.) </small>
                    <Field
                        as="textarea"
    ...
    render(){
        ...
        return (
            <div>
                ...
                <div className="form-group">
                    <label className="control-label">Where did you find participants:
                        <span style={{ color: "red" }}>*</span>
                    </label>
                    <small className="text-muted"> Please select all that apply</small>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "recruitmentParticipantsSource")}`} type="checkbox" name="recruitmentParticipantsSource" value="Own Client Rosters" />
                        <label className="form-check-label" htmlFor="Own Client Rosters">Your own client rosters/contact lists</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "recruitmentParticipantsSource")}`} type="checkbox" name="recruitmentParticipantsSource" value="Postings in the community" />
                        <label className="form-check-label" htmlFor="Postings in the community">Postings in the community</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "recruitmentParticipantsSource")}`} type="checkbox" name="recruitmentParticipantsSource" value="Social media" />
                        <label className="form-check-label" htmlFor="Social media">Social media</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "recruitmentParticipantsSource")}`} type="checkbox" name="recruitmentParticipantsSource" value="Networking with other organizations" />
                        <label className="form-check-label" htmlFor="Networking with other organizations">Networking with other organizations</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "recruitmentParticipantsSource")}`} type="checkbox" name="recruitmentParticipantsSource" value="Recruitment assistance from WorkBC" />
                        <label className="form-check-label" htmlFor="Recruitment assistance from WorkBC">Recruitment assistance from WorkBC</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "recruitmentParticipantsSource")}`} type="checkbox" name="recruitmentParticipantsSource" value="other" />
