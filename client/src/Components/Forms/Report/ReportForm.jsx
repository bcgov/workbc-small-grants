...
class ReportForm extends Component {
                ...
                <div>
                    ...
                    <div className="form-group">
                        ...
                        <small className="text-muted" id="clientAddress1">
                            {" "}
                            Please provide the 10 character ID.
                        </small>
                        <Field
    ...
    get nextButton() {
        ...
        if (currentStep < 5) {
            return (
                <button className="btn btn-primary float-right" type="button" onClick={this._next} disabled={this.state.hasError}>
                    Next
                </button>
            )
        }
                    ...
                    <div className="col-md-12">
                        <Formik
                            initialValues={{
                                ...
                                recipientDisclosureConsentName: "",
                            ...
                            {(props) => (
                                <Form>
                                    ...
                                    {this.state.currentStep === 5 && (
                                        <div>
                                            <FollowUpForm {...props} />
                                            <div className="form-group">{this.showErrors(props.errors, props.submitCount)}</div>
                                            <Consent />
                                            <button
