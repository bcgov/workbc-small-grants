    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="participantEncounterProblems">
                        Did participants encounter problems or difficulties in their placements? If so, what were they, and how did you help solve
                        them?
                    </label>
                    <small className="text-muted" id="participantEncounterProblems">
                        {" "}
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="participantsNotAbleToStartOrComplete">
                        If participants were not able to start or complete their placements, please explain why.
                    </label>
                    <small className="text-muted" id="participantsNotAbleToStartOrComplete">
                        {" "}
                        Please describe (500 characters max.){" "}
                    </small>
                    <Field
