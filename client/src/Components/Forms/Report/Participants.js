...
class ParticipantsForm extends Component{
    get participantsNotAbleToComplete() {
        ...
        for(var i = 1; i <= this.props.values.numberOfParticipantsNotAbleToComplete; i++){
            ...
            return (
                <div>
                    <div className="form-group">
                        <label className="col-form-label control-label" htmlFor="numberOfParticipantsNotAbleToComplete">How many participants were not able to complete their placements?<span
                                    ...
                                    <div key={index}>
                                        <div className="form-group">
                                            <label className="col-form-label control-label">
                                                How many weeks did participant #{index+1} complete? (*if final week was a partial week, count it as a full week)
                                            ...
                                            {
                                                (this.props.values.participantsNotAbleToComplete[index]?.newParticipantFound === "yes" || this.props.values.participantsNotAbleToComplete[index]?.newParticipantFound === "no") &&
                                                <div className="form-group">
                                                    <label className="col-form-label control-label" htmlFor={`participantsNotAbleToComplete[${index}].explanation`}>
                                                        Please explain 
                                                        <span style={{ color: "red" }}>
                                                            *
                                                        </span>
    ...
    render(){
        return (
            <div>
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="participantsNumber">How many participants started their placement? <span
                        style={{ color: "red" }}>*</span></label>
                    <Field className={`form-control ${feedBackClassName(this.props.errors, this.props.touched, "participantsNumber")}`} id="participantsNumber" name="participantsNumber" />
