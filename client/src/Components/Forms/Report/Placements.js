        ...
        return (
            <div>
                ...
                <div className="form-group">
                    ...
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "placementSupportsProvided")}`} type="checkbox" name="placementSupportsProvided" value="Essential work clothing, supplies, tools or equipment" />
                        <label className="form-check-label" htmlFor="Essential work clothing, supplies, tools or equipment">Essential work clothing, supplies, tools or equipment</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "placementSupportsProvided")}`} type="checkbox" name="placementSupportsProvided" value="Personal protective equipment" />
                        <label className="form-check-label" htmlFor="Personal protective equipment">Personal protective equipment</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "placementSupportsProvided")}`} type="checkbox" name="placementSupportsProvided" value="Assistive technology" />
                        <label className="form-check-label" htmlFor="Assistive technology">Assistive technology</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "placementSupportsProvided")}`} type="checkbox" name="placementSupportsProvided" value="On-the-job training" />
                        <label className="form-check-label" htmlFor="On-the-job training">On-the-job training</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "placementSupportsProvided")}`} type="checkbox" name="placementSupportsProvided" value="Job coaching/mentorship" />
                        <label className="form-check-label" htmlFor="Job coaching/mentorship">Job coaching/mentorship</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "placementSupportsProvided")}`} type="checkbox" name="placementSupportsProvided" value="Entry-level certification" />
                        <label className="form-check-label" htmlFor="Entry-level certification">Entry-level certification (such as FOODSAFE)</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "placementSupportsProvided")}`} type="checkbox" name="placementSupportsProvided" value="Transportation" />
                        <label className="form-check-label" htmlFor="Transportation">Transportation</label>
                    </div>
                    <div className="form-check">
                        <Field className={`form-check-input ${feedBackClassName(this.props.errors, this.props.touched, "placementSupportsProvided")}`} type="checkbox" name="placementSupportsProvided" value="Childcare" />
