        ...
        if (this.props.values.numberOfParticipantsOther !== "0" && this.props.values.numberOfParticipantsOther !== "") {
            return (
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="numberOfParticipantsOtherDescribe">
                        Please explain <span style={{ color: "red" }}>*</span>
                    </label>
                    <small className="text-muted" id="numberOfParticipantsOtherDescribe">
                        {" "}
                        500 characters max
                    </small>
                    <Field
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="form-group">
                    <p>
                        To the best of your knowledge, please indicate any changes in participant employment status as a result of their participation
                        in the Work Experience Opportunities Grant program. For each comment below, please indicate the number of participants that
                        the comment relates to.
                    </p>
                    <p>After the program concluded, how many:</p>
                </div>
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="numberOfParticipantsStayedInPosition">
                        Participants stayed in their positions and were hired by my organization<span style={{ color: "red" }}>*</span>
                    </label>
                </div>
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="numberOfParticipantsHiredDifferentRole">
                        Participants were hired by my organization into a new/different role<span style={{ color: "red" }}>*</span>
                    </label>
                </div>
                <div className="form-group mx-auto">
                    <div className="form-check form-check-inline">
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="numberOfParticipantsConnectedToWorkBC">
                        Participants were connected to WorkBC to receive additional supports<span style={{ color: "red" }}>*</span>
                    </label>
                </div>
                <div className="form-group mx-auto">
                    <div className="form-check form-check-inline">
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="numberOfParticipantsWillContinueEmploymentServicesAndSupportsCurrentOrg">
                        Participants will continue to receive employment-related services and supports from my organization
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="numberOfParticipantsOther">
                        Other
                    </label>
                </div>
                <div className="form-group mx-auto">
