            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <p>If you have additional questions or require assistance, please review the guidelines here, or contact <a href="mailto:WorkExperienceGrants@gov.bc.ca">WorkExperienceGrants@gov.bc.ca</a></p>
                        <hr />
