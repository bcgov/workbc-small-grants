...
class SurveyParticipantStep0 extends Component {
    handleWorkExperience() {
            ...
            return (
                <div>
                    <div className="form-group">
                        <label className="col-form-label control-label" htmlFor="workExperienceStartDate">
                            When did you start your work experience? <span style={{ color: "red" }}>*</span>
                        </label>
                        <MonthPickerField
        ...
        if (this.props.values.hasStartedWorkExperience === "no") {
            return (
                <div>
                    <button
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="hasStartedWorkExperience">
                        Have you started your work experience?<span style={{ color: "red" }}>* </span>
                    </label>
                    <div className="form-check">
                        <Field
                            ...
                            value="yes"
                        />
                        <label className="form-check-label" htmlFor="hasStartedWorkExperienceYes">
                            Yes
                        </label>
                    </div>
                    <div className="form-check">
                        <Field
                            ...
                            value="no"
                        />
                        <label className="form-check-label" htmlFor="hasStartedWorkExperienceNo">
                            No
                        </label>
