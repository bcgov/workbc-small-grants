                    ...
                    <div className="row">
                        <div className="col-md-6 col-sm-12 col-xs-12">
                            <label className="col-form-label control-label" htmlFor="receivedOtherWorkBCServicesOrPrograms">
                                Prior to this experience, I have received WorkBC services or participated in WorkBC programs.
                    ...
                    <div className="row">
                        <div className="col-md-6 col-sm-12 col-xs-12">
                            <label className="col-form-label control-label" htmlFor="likelyToParticipateInSimilarProgram">
                                I am likely to participate in similar programs with WorkBC in the future.<span style={{ color: "red" }}>*</span>
                            </label>
                        </div>
                        <div className="form-check col">
                            <Field
                    ...
                    <div className="row">
                        <div className="col-md-6 col-sm-12 col-xs-12">
                            <label className="col-form-label control-label" htmlFor="likelyToRecommendGrant">
                                I would recommend this opportunity to other individuals when it becomes available again.
                                <span style={{ color: "red" }}>*</span>
                            </label>
                        </div>
                        <div className="form-check col">
