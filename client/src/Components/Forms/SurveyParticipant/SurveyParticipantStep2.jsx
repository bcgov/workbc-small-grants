...
class SurveyParticipantStep2 extends Component {
    render() {
        ...
        return (
            <div>
                <p>
                    Thinking about the <b>work experience and the organization ,</b> please rate your level of agreement with the following
                    statements:
                </p>
                <p>
                ...
                <div className="form-group">
                    ...
                    <div className="row">
                        <div className="col-md-6 col-sm-12 col-xs-12">
                            <label className="control-label" htmlFor="overallExperienceWithOrganization">
                                My overall experience with the organization has been positive.<span style={{ color: "red" }}>*</span>
                            </label>
                        </div>
                ...
                <div className="form-group">
                    <div className="row">
                        <div className="col-md-6 col-sm-12 col-xs-12">
                            <label className="control-label" htmlFor="levelOfSupportsReceived">
                                I am satisfied with the level of supports received from the organization.<span style={{ color: "red" }}>*</span>
                            </label>
                        </div>
                        <div className="form-check col">
                            <Field
                ...
                <div className="form-group">
                    <div className="row">
                        <div className="col-md-6 col-sm-12 col-xs-12">
                            <label className="control-label" htmlFor="increasedAbilityGettingAndKeepingJob">
                                This experience has improved my abilities for getting and keeping a job.<span style={{ color: "red" }}>*</span>
                            </label>
                        </div>
                        <div className="form-check col">
                            <Field
                ...
                <div className="form-group">
                    <label className="col-form-label control-label" htmlFor="organizationAndExperienceComments">
                        Please provide any additional details or comments about the organization and your work experience so far.
                    </label>
                    <small className="text-muted" id="organizationAndExperienceComments">
                        {" "}
                        (1000 characters max.)
                    </small>
                    <Field
