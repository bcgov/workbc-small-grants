                ...
                <div className="row">
                    <div className="col-md-12">
                        ...
                        >
                            {(props) => (
                                <Form>
                                    <SurveyParticipantStep0 currentStep={this.state.currentStep} {...props} />
                                    <SurveyParticipantStep1 currentStep={this.state.currentStep} {...props} />
                                    <SurveyParticipantStep2 currentStep={this.state.currentStep} {...props} />
                                    <SurveyParticipantStep3 currentStep={this.state.currentStep} {...props} />
                                    <SurveyParticipantStep4 currentStep={this.state.currentStep} {...props} />
