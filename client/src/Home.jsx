            ...
            <div className="row">
                <div className="col-md-12">
                    <div className="alert alert-primary" role="alert">
                        <p>
                            <b>
                                The Work Experience Opportunities Grant application window is now closed. Thanks for your interest in this funding
                                opportunity. Check back to learn about how many participants and organizations were supported through this program as
                                well as potential future funding opportunities.
                            </b>
                        </p>
                        <p />
                        <hr />
                        <p className="mb-0">
                            If you have questions, please contact the ministry at{" "}
                    ...
                    <p>
                        ...
                        <a
                            href="https://www.workbc.ca/Employment-Services/Work-Experience-Opportunities-Grant.aspx"
                            target="_blank"
