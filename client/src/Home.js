        ...
        <div className="container">
            ...
            <div className="row" style={{marginTop:'2em'}}>
                <div className="col-md-12">
                    ...
                    <p className="small">
                    Personal information collected on this form is collected under the authority of sections 26 (c) and (e) of the Freedom of Information and Protection of Privacy Act (FOIPPA) and is subject to all of the provisions of that Act. The personal information collected may be used by the Ministry of Social Development and Poverty Reduction, its service providers and associates of those service providers to administer and evaluate the effectiveness of Grants. Under the authority of section 33.1 (d) of FOIPPA, the personal information collected may also be disclosed to Employment and Social Development Canada or the Canada Employment Insurance Commission, either of which may use your personal information to monitor, assess or evaluate the effectiveness of Grants. If you have any questions about the collection, use or disclosure of your personal information, please contact the Records clerk of the Employment and Labour Market Services Division, Ministry of Social Development and Poverty Reduction at <a href="mailto:WorkBCOESprivacy@gov.bc.ca">WorkBCOESprivacy@gov.bc.ca</a>.
                    </p>
